  ...
  return (
    <div id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <h1 className="mb-6 text-5xl md:text-6xl drop-shadow-2xl">
          Solo Envía tu Foto, <br />Nosotros Hacemos el Resto
        </h1>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
            <a href="#combos" className="px-8 py-4 bg-white text-black rounded-lg hover:bg-amber-50 transition-all transform hover:scale-105 shadow-xl flex items-center gap-2">
            <ShoppingBag className="w-5 h-5" />
            Ver Colección
            </a>
            <a href={whatsappUrl} className="px-8 py-4 border-2 border-white text-white rounded-lg hover:bg-white hover:text-black transition-all transform hover:scale-105 backdrop-blur-sm">
            Cotizar Ahora
            </a>
        </div>
      </div>
